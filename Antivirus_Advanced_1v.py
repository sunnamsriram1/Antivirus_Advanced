#➜ **Fix**
#- ✅ User input loop add చేశాను (URL scan / exit)
#- ✅ Real-time scan అలాగే ఉంటుంది
#- ✅ Manual URL scan user input ద్వారా

#---

# 🛡️ FIXED ADVANCED MINI ANTIVIRUS (FULL CODE)
...
def generate_report():
  with open(REPORT_FILE, "w") as f:
      ...
      f.write("See antivirus_log.txt for full logs\n")
...
if __name__ == "__main__":
  ...
  print("📌 Drop any file inside 'scan_files' folder")
